...
export default function PsheLesson() {
  ...
  const topic = params.topic as keyof typeof psheLessons;
  const lesson = psheLessons[topic];
  ...
  if (isFinished) {
    return (
      <div className="min-h-[100dvh] gradient-pshe flex items-center justify-center p-6">
        <motion.div
                  ...
                  <motion.button
                    ...
                    className={`relative p-6 rounded-2xl text-xl font-black transition-all ${
                      showCorrect
                        ...
                        : 'bg-gradient-to-br from-violet-100 to-fuchsia-100 dark:from-violet-900 dark:to-fuchsia-900 text-foreground hover:scale-105'
                    }`}
            ...
            {showFeedback && (
              ...
              >
                ...
                <Button
                  onClick={handleNext}
                  size="lg"
                  className="w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-700 hover:to-fuchsia-700 text-white font-black text-xl rounded-2xl h-16"

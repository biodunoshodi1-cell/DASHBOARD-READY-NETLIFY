...
export default function ScienceLesson() {
  ...
  const topic = params.topic as keyof typeof scienceLessons;
  const lesson = scienceLessons[topic];
  ...
  if (isFinished) {
    return (
      <div className="min-h-[100dvh] gradient-science flex items-center justify-center p-6">
        <motion.div
              ...
              {currentQuestion.options.map((option, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className={`relative p-6 rounded-2xl text-xl font-black transition-all ${
                      showCorrect
                        ...
                        : 'bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900 dark:to-teal-900 text-foreground hover:scale-105'
                    }`}
            ...
            {showFeedback && (
              ...
              >
                ...
                <Button
                  onClick={handleNext}
                  size="lg"
                  className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-black text-xl rounded-2xl h-16"

...
export default function GeographyLesson() {
  ...
  const topic = params.topic as keyof typeof geographyLessons;
  const lesson = geographyLessons[topic];
  ...
  if (isFinished) {
    return (
      <div className="min-h-[100dvh] gradient-geography flex items-center justify-center p-6">
        <motion.div
                  ...
                  <motion.button
                    ...
                    className={`relative p-6 rounded-2xl text-xl font-black transition-all ${
                      showCorrect
                        ...
                        : 'bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900 dark:to-orange-900 text-foreground hover:scale-105'
                    }`}
            ...
            {showFeedback && (
              ...
              >
                ...
                <Button
                  onClick={handleNext}
                  size="lg"
                  className="w-full bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-black text-xl rounded-2xl h-16"

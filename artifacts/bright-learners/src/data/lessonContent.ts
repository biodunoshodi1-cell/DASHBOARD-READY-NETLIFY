...
export const mathLessons: Record<string, MathLesson> = {
  ...
  'time-oclock': {
    title: "Telling the Time: O'Clock, Half Past, Quarter Past & Quarter To",
    year: 1,
    strand: 'Measurement - time',
    questions: [
      { id: 'toc-1', question: 'What time does the clock show?', clockTime: { hour: 3, minute: 0 }, options: ["3 o'clock", 'half past 3', "9 o'clock", "12 o'clock"], correct: "3 o'clock", hint: "When the minute hand points to 12, it is o'clock" },
      { id: 'toc-2', question: 'What time does the clock show?', clockTime: { hour: 7, minute: 0 }, options: ["7 o'clock", 'half past 7', 'quarter past 12', "1 o'clock"], correct: "7 o'clock", hint: 'The hour hand points to 7 and the minute hand points to 12' },
      { id: 'toc-3', question: 'What time does the clock show?', clockTime: { hour: 9, minute: 30 }, options: ["9 o'clock", 'half past 9', 'quarter to 4', "6 o'clock"], correct: 'half past 9', hint: 'The minute hand pointing to 6 means half past' },
      { id: 'toc-4', question: 'What time does the clock show?', clockTime: { hour: 12, minute: 30 }, options: ["12 o'clock", 'half past 12', 'half past 6', "1 o'clock"], correct: 'half past 12', hint: 'Half past 12 means half way to 1 o\u2019clock' },
      { id: 'toc-5', question: 'What time does the clock show?', clockTime: { hour: 5, minute: 0 }, options: ["5 o'clock", 'half past 5', "11 o'clock", "10 o'clock"], correct: "5 o'clock", hint: "The minute hand at 12 means it's o'clock" },
      { id: 'toc-6', question: 'What time does the clock show?', clockTime: { hour: 2, minute: 30 }, options: ["2 o'clock", 'half past 2', "8 o'clock", "3 o'clock"], correct: 'half past 2', hint: 'The minute hand is on the 6' },
      ...
      { id: 'toc-9', question: 'What time does the clock show?', clockTime: { hour: 6, minute: 30 }, options: ["6 o'clock", 'half past 6', 'half past 12', "7 o'clock"], correct: 'half past 6', hint: 'Half past 6 is between 6 and 7' },
      { id: 'toc-10', question: 'What time does the clock show?', clockTime: { hour: 11, minute: 0 }, options: ["11 o'clock", 'half past 11', "1 o'clock", "10 o'clock"], correct: "11 o'clock", hint: "The minute hand points straight up for o'clock" },
      { id: 'toc-11', question: 'What time does the clock show?', clockTime: { hour: 1, minute: 15 }, options: ["1 o'clock", 'quarter past 1', 'quarter to 2', 'half past 1'], correct: 'quarter past 1', hint: 'The minute hand on the 3 means quarter past' },
      { id: 'toc-12', question: 'What time does the clock show?', clockTime: { hour: 4, minute: 45 }, options: ['quarter to 5', 'quarter past 4', "5 o'clock", 'half past 4'], correct: 'quarter to 5', hint: 'The minute hand on the 9 means quarter to the next hour' },
      { id: 'toc-13', question: 'What time does the clock show?', clockTime: { hour: 10, minute: 30 }, options: ["10 o'clock", 'half past 10', 'quarter past 10', 'half past 11'], correct: 'half past 10', hint: 'The minute hand on the 6 means half past' },
      { id: 'toc-14', question: 'What time does the clock show?', clockTime: { hour: 3, minute: 15 }, options: ["3 o'clock", 'quarter past 3', 'quarter to 4', 'half past 3'], correct: 'quarter past 3', hint: 'Quarter past means 15 minutes have gone by' },
      { id: 'toc-15', question: 'What time does the clock show?', clockTime: { hour: 9, minute: 45 }, options: ['quarter to 10', 'quarter past 9', "10 o'clock", 'half past 9'], correct: 'quarter to 10', hint: 'Quarter to 10 means 45 minutes past 9' },
      { id: 'toc-16', question: 'Which time is "quarter past 6"?', options: ['6:00', '6:15', '6:30', '6:45'], correct: '6:15', hint: 'Quarter past means 15 minutes' },
      { id: 'toc-17', question: 'Which time is "quarter to 3"?', options: ['3:00', '2:45', '2:15', '3:15'], correct: '2:45', hint: 'Quarter to means 15 minutes before the hour' },
    ],
  },
  '2d-shapes': {
    title: '2D Shapes',
  ...
  time: {
    ...
    strand: 'Measurement - time',
    questions: [
      { id: 'time-1', question: 'What time does the clock show?', clockTime: { hour: 3, minute: 0 }, options: ["3 o'clock", 'half past 3', "9 o'clock", 'quarter past 12'], correct: "3 o'clock", hint: 'The hour hand points to 3 and the minute hand points straight up to 12 — that means o\u2019clock' },
      { id: 'time-2', question: 'What time does the clock show?', clockTime: { hour: 6, minute: 0 }, options: ["6 o'clock", 'half past 12', 'half past 6', "5 o'clock"], correct: "6 o'clock", hint: 'The minute hand is on the 12, so it is an exact hour' },
      { id: 'time-3', question: 'What time does the clock show?', clockTime: { hour: 9, minute: 30 }, options: ["9 o'clock", 'half past 9', 'quarter to 4', 'half past 10'], correct: 'half past 9', hint: 'The minute hand points to 6, which means half past' },
      { id: 'time-4', question: 'What time does the clock show?', clockTime: { hour: 12, minute: 30 }, options: ["12 o'clock", 'half past 12', 'half past 6', 'half past 1'], correct: 'half past 12', hint: 'Half past means the minute hand is on the 6' },
      { id: 'time-5', question: 'What time does the clock show?', clockTime: { hour: 4, minute: 15 }, options: ["4 o'clock", 'quarter past 4', 'quarter to 5', 'quarter past 3'], correct: 'quarter past 4', hint: 'The minute hand points to the 3, which means quarter past' },
      { id: 'time-6', question: 'What time does the clock show?', clockTime: { hour: 8, minute: 15 }, options: ["8 o'clock", 'quarter past 8', 'quarter to 9', 'quarter past 7'], correct: 'quarter past 8', hint: 'Quarter past means 15 minutes have gone by' },
      { id: 'time-7', question: 'What time does the clock show?', clockTime: { hour: 5, minute: 45 }, options: ['quarter to 6', 'quarter past 5', "6 o'clock", 'quarter past 6'], correct: 'quarter to 6', hint: 'The minute hand points to the 9, which means quarter to the next hour' },
      { id: 'time-8', question: 'What time does the clock show?', clockTime: { hour: 10, minute: 45 }, options: ['quarter to 11', 'quarter past 11', 'quarter past 10', 'quarter to 10'], correct: 'quarter to 11', hint: 'Quarter to 11 means 45 minutes past 10' },
      { id: 'time-9', question: 'What time does the clock show?', clockTime: { hour: 2, minute: 0 }, options: ["2 o'clock", 'half past 2', 'quarter past 12', "10 o'clock"], correct: "2 o'clock", hint: 'Both hands help you tell the exact hour' },
      { id: 'time-10', question: 'What time does the clock show?', clockTime: { hour: 7, minute: 30 }, options: ["7 o'clock", 'half past 7', 'half past 6', 'half past 8'], correct: 'half past 7', hint: 'Half past 7 is halfway between 7 and 8 o\u2019clock' },
      { id: 'time-11', question: 'What time does the clock show?', clockTime: { hour: 1, minute: 45 }, options: ['quarter to 2', 'quarter past 1', "2 o'clock", 'quarter to 1'], correct: 'quarter to 2', hint: 'The minute hand on the 9 means quarter to the next hour' },
      { id: 'time-12', question: 'What time does the clock show?', clockTime: { hour: 11, minute: 15 }, options: ["11 o'clock", 'quarter past 11', 'quarter to 12', 'quarter past 10'], correct: 'quarter past 11', hint: 'The minute hand on the 3 means quarter past' },
      { id: 'time-13', question: 'What time does the clock show?', clockTime: { hour: 3, minute: 30 }, options: ["3 o'clock", 'half past 3', 'quarter past 3', 'half past 4'], correct: 'half past 3', hint: 'The minute hand on the 6 means half past' },
      { id: 'time-14', question: 'Which time is "quarter to 8"?', options: ['8:00', '7:45', '7:15', '8:15'], correct: '7:45', hint: 'Quarter to means 15 minutes before the hour' },
      { id: 'time-15', question: 'Which time is "quarter past 9"?', options: ['9:00', '9:15', '9:45', '9:30'], correct: '9:15', hint: 'Quarter past means 15 minutes after the hour' },
      { id: 'time-16', question: 'What time does the clock show?', clockTime: { hour: 6, minute: 45 }, options: ['quarter to 7', 'quarter past 6', "7 o'clock", 'quarter past 7'], correct: 'quarter to 7', hint: 'Quarter to 7 means 45 minutes past 6' },
      { id: 'time-17', question: 'What time does the clock show?', clockTime: { hour: 12, minute: 15 }, options: ["12 o'clock", 'quarter past 12', 'quarter to 1', 'half past 12'], correct: 'quarter past 12', hint: 'Quarter past 12 means 15 minutes after 12' },
    ],
  },
  shapes: {
  ...
  'place-value-1000': {
    ...
    strand: 'Number - number and place value',
    questions: [
      { id: 'pv1000-1', question: 'What is the value of the 4 in 743?', options: ['4', '40', '400', '4000'], correct: '40', hint: 'It is in the tens place' },
...
/**
 * Same idea as buildPhonicsQuiz, but phrased for word parts (suffixes and
 * prefixes) rather than individual letter sounds — used for the Year 2
 * suffix/prefix categories below.
 */
function buildWordPartQuiz(items: PhonicsSound[], partType: 'suffix' | 'prefix'): QuizQuestion[] {
  return items.map((item, index) => {
    const distractors = items
      .filter((_, i) => i !== index)
      .map((s) => s.example);
    const wrongOptions = [distractors[index % distractors.length], distractors[(index + 1) % distractors.length], distractors[(index + 2) % distractors.length]];
    const options = [item.example, ...wrongOptions].sort(() => 0.5 - ((index * 37) % 100) / 100);
    return {
      id: `${item.id}-quiz`,
      question: `Which word contains the ${partType} "${item.sound}"?`,
      options,
      correct: item.example,
      hint: `Look for "${item.sound}" in the word`,
    };
  });
}
...
export const phonicsSounds = {
  ...
  // ==================== YEAR 2 ====================
  rControlledVowels: [
    { id: 'ir', sound: 'ir', example: 'bird', pronunciation: 'R-controlled vowel sound (er)' },
    { id: 'ur', sound: 'ur', example: 'burn', pronunciation: 'R-controlled vowel sound (er)' },
    { id: 'er', sound: 'er', example: 'her', pronunciation: 'R-controlled vowel sound' },
    { id: 'or', sound: 'or', example: 'for', pronunciation: 'OR sound' },
    { id: 'ar', sound: 'ar', example: 'car', pronunciation: 'AR sound' },
    { id: 'ear-sound', sound: 'ear', example: 'hear', pronunciation: 'EAR sound (eer)' },
    { id: 'air-sound', sound: 'air', example: 'hair', pronunciation: 'AIR sound' },
    { id: 'are-sound', sound: 'are', example: 'care', pronunciation: 'ARE sound (air)' },
    { id: 'ore', sound: 'ore', example: 'more', pronunciation: 'ORE sound' },
    { id: 'oar', sound: 'oar', example: 'roar', pronunciation: 'OAR sound (or)' },
  ],
  moreVowelTeams: [
    { id: 'igh', sound: 'igh', example: 'light', pronunciation: 'Long I sound' },
    { id: 'ow-loud', sound: 'ow', example: 'how', pronunciation: 'OW sound (as in cow)' },
    { id: 'ou', sound: 'ou', example: 'out', pronunciation: 'OU sound' },
    { id: 'aw', sound: 'aw', example: 'paw', pronunciation: 'AW sound' },
    { id: 'au', sound: 'au', example: 'author', pronunciation: 'AU sound (or)' },
    { id: 'ew', sound: 'ew', example: 'few', pronunciation: 'EW sound' },
    { id: 'oe', sound: 'oe', example: 'toe', pronunciation: 'Long O sound' },
    { id: 'ei', sound: 'ei', example: 'eight', pronunciation: 'Long A sound' },
    { id: 'ey', sound: 'ey', example: 'they', pronunciation: 'Long A sound' },
    { id: 'y-long-i', sound: 'y', example: 'fly', pronunciation: 'Long I sound (y as a vowel)' },
  ],
  suffixes: [
    { id: 'suf-ing', sound: '-ing', example: 'jumping', pronunciation: 'Suffix for actions happening now' },
    { id: 'suf-ed', sound: '-ed', example: 'jumped', pronunciation: 'Suffix for the past tense' },
    { id: 'suf-er', sound: '-er', example: 'faster', pronunciation: "Suffix meaning 'more'" },
    { id: 'suf-est', sound: '-est', example: 'fastest', pronunciation: "Suffix meaning 'most'" },
    { id: 'suf-ly', sound: '-ly', example: 'slowly', pronunciation: 'Suffix that turns an adjective into an adverb' },
    { id: 'suf-ful', sound: '-ful', example: 'careful', pronunciation: "Suffix meaning 'full of'" },
    { id: 'suf-less', sound: '-less', example: 'careless', pronunciation: "Suffix meaning 'without'" },
    { id: 'suf-ness', sound: '-ness', example: 'happiness', pronunciation: 'Suffix that turns an adjective into a noun' },
    { id: 'suf-y', sound: '-y', example: 'sunny', pronunciation: "Suffix meaning 'like' or 'full of'" },
    { id: 'suf-es', sound: '-es', example: 'boxes', pronunciation: 'Suffix used to make some words plural' },
  ],
  prefixes: [
    { id: 'pre-un', sound: 'un-', example: 'unhappy', pronunciation: "Prefix meaning 'not'" },
    { id: 'pre-re', sound: 're-', example: 'redo', pronunciation: "Prefix meaning 'again'" },
    { id: 'pre-dis', sound: 'dis-', example: 'disagree', pronunciation: "Prefix meaning 'not' or 'opposite of'" },
    { id: 'pre-mis', sound: 'mis-', example: 'mistake', pronunciation: "Prefix meaning 'wrongly'" },
    { id: 'pre-non', sound: 'non-', example: 'nonstop', pronunciation: "Prefix meaning 'not'" },
    { id: 'pre-pre', sound: 'pre-', example: 'preview', pronunciation: "Prefix meaning 'before'" },
  ],
};
...
export const phonicsQuizzes: Record<string, QuizQuestion[]> = {
  ...
  rControlledVowels: buildPhonicsQuiz(phonicsSounds.rControlledVowels),
  moreVowelTeams: buildPhonicsQuiz(phonicsSounds.moreVowelTeams),
  suffixes: buildWordPartQuiz(phonicsSounds.suffixes, 'suffix'),
  prefixes: buildWordPartQuiz(phonicsSounds.prefixes, 'prefix'),
};

export type MathQuestion = {
  ...
  image?: string;
  /** Objects to count, one entry per item - used for "how many X?" questions
   * so each item renders as its own icon in a tidy wrapped grid, instead of
   * being crammed into a single giant text string (which either overflowed
   * or wrapped mid-character on smaller screens). */
  countItems?: string[];
...
export const mathLessons: Record<string, MathLesson> = {
  counting: {
    title: 'Counting',
    questions: [
      { id: 'count-1', question: 'How many stars?', countItems: ['⭐', '⭐', '⭐'], options: ['2', '3', '4', '5'], correct: '3', hint: 'Count each star one by one' },
      { id: 'count-2', question: 'Count the apples', countItems: ['🍎', '🍎', '🍎', '🍎', '🍎'], options: ['4', '5', '6', '7'], correct: '5', hint: 'Point to each apple as you count' },
      { id: 'count-3', question: 'How many flowers?', countItems: ['🌸', '🌸', '🌸', '🌸', '🌸', '🌸', '🌸'], options: ['6', '7', '8', '9'], correct: '7', hint: 'Count from left to right' },
      { id: 'count-4', question: 'Count the hearts', countItems: ['❤️', '❤️', '❤️', '❤️'], options: ['3', '4', '5', '6'], correct: '4', hint: 'How many can you see?' },
      { id: 'count-5', question: 'How many balloons?', countItems: ['🎈', '🎈', '🎈', '🎈', '🎈', '🎈'], options: ['5', '6', '7', '8'], correct: '6', hint: 'Count each balloon' },
      { id: 'count-6', question: 'Count to 10', image: '1 2 3 4 5 6 7 8 9 ?', options: ['9', '10', '11', '12'], correct: '10', hint: 'What comes after 9?' },
      { id: 'count-7', question: 'How many dots?', countItems: ['🔴', '🔴', '🔴', '🔴', '🔴', '🔴', '🔴', '🔴', '🔴'], options: ['8', '9', '10', '11'], correct: '9', hint: 'Count carefully' },
      { id: 'count-8', question: 'Count the circles', countItems: ['🔵', '🔵', '🔵', '🔵', '🔵', '🔵', '🔵', '🔵'], options: ['7', '8', '9', '10'], correct: '8', hint: 'One by one' },
      { id: 'count-9', question: 'What number comes after 5?', image: '1 2 3 4 5 ?', options: ['4', '5', '6', '7'], correct: '6', hint: 'Count up!' },
      { id: 'count-10', question: 'How many stars in total?', countItems: ['⭐', '⭐', '⭐', '⭐', '⭐'], options: ['4', '5', '6', '7'], correct: '5', hint: 'Count both groups together: 2 stars plus 3 more stars' },
    ],
  },
  addition: {
    title: 'Addition',
  ...
  time: {
    ...
    questions: [
      ...
      // "Identify the term" questions: instead of reading the exact time,
      // these ask which naming word matches what the clock shows -
      // practicing the vocabulary itself (half past / quarter past /
      // quarter to / o'clock), not just digital-time reading.
      { id: 'time-11', question: 'What do we call this time?', clockTime: { hour: 5, minute: 0 }, options: ['O\u2019clock', 'Half past', 'Quarter past', 'Quarter to'], correct: 'O\u2019clock', hint: 'The minute hand points straight up to 12' },
      { id: 'time-12', question: 'What do we call this time?', clockTime: { hour: 3, minute: 30 }, options: ['O\u2019clock', 'Half past', 'Quarter past', 'Quarter to'], correct: 'Half past', hint: 'The minute hand points to the 6 - halfway around the clock' },
      { id: 'time-13', question: 'What do we call this time?', clockTime: { hour: 6, minute: 15 }, options: ['O\u2019clock', 'Half past', 'Quarter past', 'Quarter to'], correct: 'Quarter past', hint: 'The minute hand points to the 3 - a quarter of the way around' },
      { id: 'time-14', question: 'What do we call this time?', clockTime: { hour: 9, minute: 45 }, options: ['O\u2019clock', 'Half past', 'Quarter past', 'Quarter to'], correct: 'Quarter to', hint: 'The minute hand points to the 9 - a quarter left before the next hour' },
    ],
  },
  shapes: {
    title: 'Shapes',
